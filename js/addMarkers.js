  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        reviewPlane.setAttribute('geometry', {width:1.5, height:0.3})
        reviewPlane.setAttribute('material', {color:'#f0630f'})
        reviewPlane.setAttribute('rotation', {x:-90, y:0, z:0})
        reviewPlane.setAttribute('visible', false)
        var review=document.creatElement('a-entity')
        ...
        review.setAttribute('text', {font:'mozillavr', color:'black', width:2.5, align:'center', value:`customer-review:\n${dish.last_review}`})
